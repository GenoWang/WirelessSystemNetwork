...
// Author: Yg Song
// MCMI: maximum number of interface per node
#define MAX_IF 12
...
public:
	...
	// Author: Yg Song
	// MCMI: number of interfaces the agent is targeting
	int nIfaces;
...
protected:
	...
	// Author: Yg Song
	// MCMI: The routing agent needs to decide which one of the interfaces
	// the outgoing packets should be routed to. Since there are now
	// multiple interfaces. The originally used ifqueue and target
	// pointers need to be modified as follows:
	...
	// MCMI: Fixed and switchable interfaces used by this node
	int fixed_interface;
	int switchable_interface;
